{pkgs, ...}: {
  ...
  xdg.dataFile."PolyMC/java/graalvm-ce-java17".source = pkgs.graalvm17-ce;
  xdg.dataFile."PolyMC/java/graalvm-ce-java11".source = pkgs.graalvm11-ce;
  # TODO I don't know why but this one polymc doesn't like
  xdg.dataFile."PolyMC/java/graalvm-ce-java8".source = builtins.fetchTarball {
  ...
  xdg.dataFile."PolyMC/java/zulu-java8".source = pkgs.zulu8;
}
