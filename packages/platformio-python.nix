{ lib, pkgs, python3Packages, fetchFromGitHub, fetchpatch, installShellFiles
, git, spdx-license-list-data, substituteAll }:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/platformio/platformio-core/commit/097de2be98af533578671baa903a3ae825d90b94.patch";
