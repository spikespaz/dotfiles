...
in stdenv.mkDerivation rec {
  ...
  enabledFonts = assert lib.assertMsg (enableBaseFonts || enableJapaneseFonts
    || enableKoreanFonts || enableSeaFonts || enableThaiFonts
    || enableChineseSimplifiedFonts || enableChineseTraditionalFonts
    || enableOtherFonts) ''
