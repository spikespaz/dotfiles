...
in {
  ...
  prtsc = pkgs.callPackage ./prtsc { inherit maintainers; };
  ttf-ms-win11 = pkgs.callPackage ./ttf-ms-win11 { inherit maintainers; };
  fastfetch = pkgs.callPackage ./fastfetch.nix { inherit maintainers; };
  firefox-pwa = pkgs.callPackage ./firefox-pwa.nix { inherit maintainers; };
  idlehack = pkgs.callPackage ./idlehack.nix { inherit maintainers; };
  mcpelauncher = pkgs.qt6.callPackage ./mcpelauncher.nix { };
  mcpelauncher-qt5 = pkgs.libsForQt5.callPackage ./mcpelauncher.nix { };
  plymouth-themes =
    pkgs.callPackage ./plymouth-themes.nix { inherit maintainers; };
